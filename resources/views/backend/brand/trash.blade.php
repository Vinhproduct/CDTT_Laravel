          ...
          <table class="table table-bodered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <a href="{{route('brand.restore',['brand'=>$brand->id])}}" class="btn btn-sm btn-success"><i class="fas fa-eye"></a>
                <a href="{{route('brand.destroy',['brand'=>$brand->id])}}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></a>
                </td>
